...
describe Ride do
  ...
  describe '#board rider' do
    it 'allows visitors to board the ride if their excitement preferences match the ride' do
      expect(@ride1.rider_log).to eq({})
    ...
    it 'allows visitors to board the ride if they are tall enough to ride the ride' do
    ...
    it 'keeps track of how many times each visitor rides the ride' do
      @ride1.board_rider(@visitor1)
      @ride1.board_rider(@visitor2)
      @ride1.board_rider(@visitor1)
    ...
    it 'deducts the cost of the ride from the visitors spending money each time they ride' do
    ...
    it 'adds the fees collected per ride to the rides total revenue' do
      expect(@ride1.total_revenue).to eq(0)
